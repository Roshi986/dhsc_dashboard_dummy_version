...
output$mapUI <- renderUI({
  if (is.null(selected())) {
    ...
    fillCol(
      flex = c(NA, 1),
      HTML(paste0("<p style = 'color: #757575;font-size: 1.1em;font-weight: bold;margin-left: 15px;'>Indicator values in selected Local Authority</p><br/>")),
      leafletOutput("map")
    )
  }
})
...
output$map <- renderLeaflet({
  ...
  if (!is.null(selected())) {
    ...
    addTiles(
      ...
      attribution = '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a> | <a href="https://www.ons.gov.uk/methodology/geography/licences">Contains OS data © Crown copyright and database right (2020)</a>'
    ) %>%
    addPolygons(
      data = sf, 
